...
class ProvenanceTreeViewer extends StatefulWidget {
  /// The root node of the provenance tree.
  final ProvenanceNode rootNode;

  /// The currently selected node's ID, used for visual highlighting.
  final String? selectedNodeId;

  /// Called when a tree node is tapped.
  final ValueChanged<ProvenanceNode>? onNodeSelected;

  /// Background color of the tree canvas.
...
class _ProvenanceTreeViewerState extends State<ProvenanceTreeViewer> {
  ...
  void _computeLayout() {
    ...
    final totalHeight =
        depthMap.length * (nodeH + spacingY) - spacingY;
